return {
    ...
    config = function()
        ...
        -- deal with unwanted auto-snippets. Uodo keeps the typed trigger.
        ...
        require("luasnip.loaders.from_vscode").load_standalone({path = "./LuaSnip/vscode/ink.code-snippets"}) -- load snippet shared with vscode.
